...
(defun json2internal (&optional  container_xml)                                                                         #|line 20|#
  (let ((fname (funcall (cdr (assoc '(cdr (assoc ' basename  path))  os))    container_xml                            #|line 21|#)))
    (let ((routings (funcall  read_and_convert_json_file    fname                                                   #|line 22|#)))
...
(defun make_component_registry (&optional )                                                                             #|line 30|#
  (return-from make_component_registry (funcall  Component_Registry ))                                                #|line 31|##|line 32|#
  )
(defun register_component (&optional  reg  template  (ok_to_overwrite  nil))                                            #|line 34|#
  (let ((name (funcall  mangle_name   (cdr (assoc ' name  template))                                                  #|line 35|#)))
    (cond
      (( and  ( in   name (cdr (assoc ' templates  reg))) (not  ok_to_overwrite))                                   #|line 36|#
        (funcall  load_error    (concatenate 'string  "Component "  (concatenate 'string (cdr (assoc ' name  template))  " already declared")) )#|line 37|#
        ))
...
(defun register_multiple_components (&optional  reg  templates)                                                         #|line 42|#
  (loop for template in  templates
    do                                                                                                                #|line 43|#
    (funcall  register_component    reg   template )                                                              #|line 44|#
    )                                                                                                                 #|line 45|#
  )
(defun get_component_instance (&optional  reg  full_name  owner)                                                        #|line 47|#
  (let ((template_name (funcall  mangle_name    full_name                                                             #|line 48|#)))
    (cond
        ...
        (let ((template (cdr (assoc '(nth  template_name  templates)  reg))))                                   #|line 50|#
          (cond
            (( equal    template  nil)                                                                        #|line 51|#
              (funcall  load_error    (concatenate 'string  "Registry Error: Can;t find component "  (concatenate 'string  template_name  " (does it need to be declared in components_to_include_in_project?")) #|line 52|#)
                ...
                (let ((instance_name  template_name))                                                   #|line 56|#
                  (cond
                    ...
                    (t                                                                                #|line 60|#
                      ...
                      Y))
                  (let ((instance (funcall (cdr (assoc ' instantiator  template))    reg   owner   instance_name  (cdr (assoc ' template_data  template)) #|line 62|#)))
                    (setf (cdr (assoc ' depth  instance)) (funcall  calculate_depth    instance   #|line 63|#))
                    (return-from get_component_instance  instance))))
              Y)))                                                                                            #|line 64|#
        )
      (t                                                                                                            #|line 65|#
        (funcall  load_error    (concatenate 'string  "Registry Error: Can't find component "  (concatenate 'string  template_name  " (does it need to be declared in components_to_include_in_project?")) #|line 66|#)
...
(defun calculate_depth (&optional  eh)                                                                                  #|line 69|#
  (cond
    ...
    (t                                                                                                                #|line 72|#
      (return-from calculate_depth (+  1 (funcall  calculate_depth   (cdr (assoc ' owner  eh)) )))                #|line 73|#
      Y))                                                                                                             #|line 74|#
  )
(defun dump_registry (&optional  reg)                                                                                   #|line 76|#
  (funcall  print )                                                                                                   #|line 77|#
  (funcall  print    "*** PALETTE ***"                                                                              #|line 78|#)
  (loop for c in (cdr (assoc ' templates  reg))
    do                                                                                                            #|line 79|#
    (funcall  print   (cdr (assoc ' name  c)) )                                                               #|line 80|#
    )
  (funcall  print    "***************"                                                                          #|line 81|#)
  (funcall  print )                                                                                           #|line 82|##|line 83|#
  )
(defun print_stats (&optional  reg)                                                                                     #|line 85|#
  (funcall  print    (concatenate 'string  "registry statistics: " (cdr (assoc ' stats  reg)))                        #|line 86|#)#|line 87|#
  )
    ...
    ((not (equal   nil  container_list))                                                                      #|line 100|#
      (loop for diagram in  container_list
        ...
        (loop for child_descriptor in (cdr (assoc 'children  diagram))
          do                                                                                      #|line 104|#
          (cond
            ((funcall  first_char_is   (cdr (assoc 'name  child_descriptor))   "$" )          #|line 105|#
              (let ((name (cdr (assoc 'name  child_descriptor))))                         #|line 106|#
                (let ((cmd (funcall (cdr (assoc ' strip  (subseq  name 1))) )))         #|line 107|#
                  (let ((generated_leaf (funcall  Template  :name  name :instantiator  shell_out_instantiate :template_data  cmd #|line 108|#)))
                    (funcall  register_component    reg   generated_leaf ))))       #|line 109|#
              )
            ((funcall  first_char_is   (cdr (assoc 'name  child_descriptor))   "'" )          #|line 110|#
              (let ((name (cdr (assoc 'name  child_descriptor))))                         #|line 111|#
                (let ((s  (subseq  name 1)))                                            #|line 112|#
                  (let ((generated_leaf (funcall  Template  :name  name :instantiator  string_constant_instantiate :template_data  s #|line 113|#)))
                    (funcall  register_component    reg   generated_leaf :ok_to_overwrite  t ))))
              B))
          )
        )                                                                                                 #|line 114|#
      ))                                                                                                      #|line 115|#
...
(defun first_char_is (&optional  s  c)                                                                                  #|line 121|#
  (return-from first_char_is ( equal    c (funcall  first_char    s                                                   #|line 122|#)))#|line 123|#
...
(defun run_command (&optional  eh  cmd  s)                                                                              #|line 127|#
  (let ((ret (funcall (cdr (assoc ' run  subprocess))    cmd :capture_output  t :input  s :encoding  "UTF_8"          #|line 128|#)))
    (cond
...
(defun Eh (&optional )                                                                                                  #|line 158|#
  (list
    (cons 'name  "")                                                                                                    #|line 159|#
    (cons 'inq (funcall (cdr (assoc ' Queue  queue)) ))                                                                 #|line 160|#
    (cons 'outq (funcall (cdr (assoc ' Queue  queue)) ))                                                                #|line 161|#
    (cons 'owner  nil)                                                                                                  #|line 162|#
    (cons 'saved_messages (funcall (cdr (assoc ' LifoQueue  queue)) )) #|  stack of saved message(s) |#                 #|line 163|#
    (cons 'inject  injector_NIY)                                                                                        #|line 164|#
    (cons 'children  nil)                                                                                               #|line 165|#
    (cons 'visit_ordering (funcall (cdr (assoc ' Queue  queue)) ))                                                      #|line 166|#
    (cons 'connections  nil)                                                                                            #|line 167|#
    (cons 'routings (funcall (cdr (assoc ' Queue  queue)) ))                                                            #|line 168|#
...
(defun send (&optional  eh  port  datum  causingMessage)                                                                #|line 208|#
  (let ((msg (funcall  make_message    port   datum                                                                   #|line 209|#)))
    (funcall  log_send  :sender  eh :sender_port  port :msg  msg :cause_msg  causingMessage                         #|line 210|#)
    (funcall  put_output    eh   msg                                                                              #|line 211|#))#|line 212|#
  )
(defun send_string (&optional  eh  port  s  causingMessage)                                                             #|line 214|#
  (let ((datum (funcall  new_datum_string    s                                                                        #|line 215|#)))
    (let ((msg (funcall  make_message  :port  port :datum  datum                                                    #|line 216|#)))
      (funcall  log_send_string  :sender  eh :sender_port  port :msg  msg :cause_msg  causingMessage              #|line 217|#)
      (funcall  put_output    eh   msg                                                                          #|line 218|#)))#|line 219|#
  )
(defun forward (&optional  eh  port  msg)                                                                               #|line 221|#
  (let ((fwdmsg (funcall  make_message    port  (cdr (assoc ' datum  msg))                                            #|line 222|#)))
    (funcall  log_forward  :sender  eh :sender_port  port :msg  msg :cause_msg  msg                                 #|line 223|#)
    (funcall  put_output    eh   msg                                                                              #|line 224|#))#|line 225|#
  )
(defun inject (&optional  eh  msg)                                                                                      #|line 227|#
  (funcall (cdr (assoc ' inject  eh))    eh   msg                                                                     #|line 228|#)#|line 229|#
...
(defun print_output_list (&optional  eh)                                                                                #|line 239|#
  (loop for m in (funcall  list   (cdr (assoc '(cdr (assoc ' queue  outq))  eh)) )
    do                                                                                                                #|line 240|#
    (funcall  print   (funcall  format_message    m ) )                                                           #|line 241|#
    )                                                                                                                 #|line 242|#
  )
...
(defun fetch_first_output (&optional  eh  port)                                                                         #|line 261|#
  (loop for msg in (funcall  list   (cdr (assoc '(cdr (assoc ' queue  outq))  eh)) )
    do                                                                                                                #|line 262|#
    (cond
...
(defun print_specific_output (&optional  eh  (port  "")  (stderr  nil))                                                 #|line 268|#
  (let (( datum (funcall  fetch_first_output    eh   port                                                             #|line 269|#)))
        ...
        ((not (equal   datum  nil))                                                                               #|line 271|#
          (cond
            ...
            (t                                                                                                #|line 274|#
              ...
              Y))
          (funcall  print   (funcall (cdr (assoc ' srepr  datum)) ) :file  outf )                           #|line 276|#
          ))))                                                                                                    #|line 277|#
  )
(defun put_output (&optional  eh  msg)                                                                                  #|line 279|#
  (funcall (cdr (assoc '(cdr (assoc ' put  outq))  eh))    msg                                                        #|line 280|#)#|line 281|#
  )
(defun injector_NIY (&optional  eh  msg)                                                                                #|line 283|#
  ...
  (funcall  print    (concatenate 'string  "Injector not implemented for this component "  (concatenate 'string (cdr (assoc ' name  eh))  (concatenate 'string  " kind ∷ "  (concatenate 'string (cdr (assoc ' kind  eh))  (concatenate 'string  ",  port ∷ " (cdr (assoc ' port  msg))))))) #|line 289|#)
  (funcall  exit )                                                                                                #|line 290|##|line 291|#
  )                                                                                                                       #|line 297|#
...
(defun probe_instantiate (&optional  reg  owner  name  template_data)                                                   #|line 308|#
  (let ((name_with_id (funcall  gensymbol    "?"                                                                      #|line 309|#)))
    (return-from probe_instantiate (funcall  make_leaf  :name  name_with_id :owner  owner :instance_data  nil :handler  probe_handler #|line 310|#)))#|line 311|#
  )
(defun probeA_instantiate (&optional  reg  owner  name  template_data)                                                  #|line 312|#
  (let ((name_with_id (funcall  gensymbol    "?A"                                                                     #|line 313|#)))
    (return-from probeA_instantiate (funcall  make_leaf  :name  name_with_id :owner  owner :instance_data  nil :handler  probe_handler #|line 314|#)))#|line 315|#
  )
(defun probeB_instantiate (&optional  reg  owner  name  template_data)                                                  #|line 317|#
  (let ((name_with_id (funcall  gensymbol    "?B"                                                                     #|line 318|#)))
    (return-from probeB_instantiate (funcall  make_leaf  :name  name_with_id :owner  owner :instance_data  nil :handler  probe_handler #|line 319|#)))#|line 320|#
  )
(defun probeC_instantiate (&optional  reg  owner  name  template_data)                                                  #|line 322|#
  (let ((name_with_id (funcall  gensymbol    "?C"                                                                     #|line 323|#)))
    (return-from probeC_instantiate (funcall  make_leaf  :name  name_with_id :owner  owner :instance_data  nil :handler  probe_handler #|line 324|#)))#|line 325|#
  )
(defun probe_handler (&optional  eh  msg)                                                                               #|line 327|#
  (let ((s (funcall (cdr (assoc '(cdr (assoc ' srepr  datum))  msg)) )))                                              #|line 328|#
    (funcall  print    (concatenate 'string  "... probe "  (concatenate 'string (cdr (assoc ' name  eh))  (concatenate 'string  ": "  s))) :file (cdr (assoc ' stderr  sys)) #|line 329|#))#|line 330|#
  )
(defun trash_instantiate (&optional  reg  owner  name  template_data)                                                   #|line 332|#
  (let ((name_with_id (funcall  gensymbol    "trash"                                                                  #|line 333|#)))
    (return-from trash_instantiate (funcall  make_leaf  :name  name_with_id :owner  owner :instance_data  nil :handler  trash_handler #|line 334|#)))#|line 335|#
  )
...
(defun deracer_instantiate (&optional  reg  owner  name  template_data)                                                 #|line 356|#
  (let ((name_with_id (funcall  gensymbol    "deracer"                                                                #|line 357|#)))
    (let ((inst (funcall  Deracer_Instance_Data    "idle"  (funcall  TwoMessages    nil   nil )                     #|line 358|#)))
      (setf (cdr (assoc ' state  inst))  "idle")                                                                  #|line 359|#
      (let ((eh (funcall  make_leaf  :name  name_with_id :owner  owner :instance_data  inst :handler  deracer_handler #|line 360|#)))
        (return-from deracer_instantiate  eh)                                                                 #|line 361|#)))#|line 362|#
  )
(defun send_first_then_second (&optional  eh  inst)                                                                     #|line 364|#
  (funcall  forward    eh   "1"  (cdr (assoc '(cdr (assoc ' first  buffer))  inst))                                   #|line 365|#)
  (funcall  forward    eh   "2"  (cdr (assoc '(cdr (assoc ' second  buffer))  inst))                                #|line 366|#)
  (funcall  reclaim_Buffers_from_heap    inst                                                                     #|line 367|#)#|line 368|#
  )
    ...
    (( equal   (cdr (assoc ' state  inst))  "idle")                                                                 #|line 372|#
      (cond
        ...
        (( equal    "2" (cdr (assoc ' port  msg)))                                                              #|line 376|#
          ...
          B)
        (t                                                                                                      #|line 379|#
          (funcall  runtime_error    (concatenate 'string  "bad msg.port (case A) for deracer " (cdr (assoc ' port  msg))) )
          Y))                                                                                                   #|line 380|#
      )
    (( equal   (cdr (assoc ' state  inst))  "waitingForFirst")                                                      #|line 381|#
      (cond
        (( equal    "1" (cdr (assoc ' port  msg)))                                                              #|line 382|#
          ...
          (funcall  send_first_then_second    eh   inst                                                   #|line 384|#)
          (setf (cdr (assoc ' state  inst))  "idle")                                                    #|line 385|#
          )
        (t                                                                                                      #|line 386|#
          (funcall  runtime_error    (concatenate 'string  "bad msg.port (case B) for deracer " (cdr (assoc ' port  msg))) )
          Y))                                                                                                   #|line 387|#
      B)
    (( equal   (cdr (assoc ' state  inst))  "waitingForSecond")                                                     #|line 388|#
      (cond
        (( equal    "2" (cdr (assoc ' port  msg)))                                                              #|line 389|#
          ...
          (funcall  send_first_then_second    eh   inst                                                   #|line 391|#)
          (setf (cdr (assoc ' state  inst))  "idle")                                                    #|line 392|#
          )
        (t                                                                                                      #|line 393|#
          (funcall  runtime_error    (concatenate 'string  "bad msg.port (case C) for deracer " (cdr (assoc ' port  msg))) )
          Y))                                                                                                   #|line 394|#
      B)
    (t                                                                                                              #|line 395|#
      (funcall  runtime_error    "bad state for deracer {eh.state}" )                                           #|line 396|#
      Y))                                                                                                           #|line 397|#
  )
(defun low_level_read_text_file_instantiate (&optional  reg  owner  name  template_data)                                #|line 399|#
  (let ((name_with_id (funcall  gensymbol    "Low Level Read Text File"                                               #|line 400|#)))
    (return-from low_level_read_text_file_instantiate (funcall  make_leaf    name_with_id   owner   nil   low_level_read_text_file_handler #|line 401|#)))#|line 402|#
  )
(defun low_level_read_text_file_handler (&optional  eh  msg)                                                            #|line 404|#
  (let ((fname (funcall (cdr (assoc '(cdr (assoc ' srepr  datum))  msg)) )))                                          #|line 405|#
...
(defun ensure_string_datum_instantiate (&optional  reg  owner  name  template_data)                                     #|line 409|#
  (let ((name_with_id (funcall  gensymbol    "Ensure String Datum"                                                    #|line 410|#)))
    (return-from ensure_string_datum_instantiate (funcall  make_leaf    name_with_id   owner   nil   ensure_string_datum_handler #|line 411|#)))#|line 412|#
  )
(defun ensure_string_datum_handler (&optional  eh  msg)                                                                 #|line 414|#
  (cond
    (( equal    "string" (funcall (cdr (assoc '(cdr (assoc ' kind  datum))  msg)) ))                                  #|line 415|#
      (funcall  forward    eh   ""   msg )                                                                        #|line 416|#
      )
    (t                                                                                                                #|line 417|#
      (let ((emsg  (concatenate 'string  "*** ensure: type error (expected a string datum) but got " (cdr (assoc ' datum  msg)))))#|line 418|#
        (funcall  send_string    eh   "✗"   emsg   msg ))                                                       #|line 419|#
      Y))                                                                                                             #|line 420|#
  )
...
(defun syncfilewrite_instantiate (&optional  reg  owner  name  template_data)                                           #|line 427|#
  (let ((name_with_id (funcall  gensymbol    "syncfilewrite"                                                          #|line 428|#)))
    (let ((inst (funcall  Syncfilewrite_Data )))                                                                    #|line 429|#
      (return-from syncfilewrite_instantiate (funcall  make_leaf    name_with_id   owner   inst   syncfilewrite_handler #|line 430|#))))#|line 431|#
  )
  ...
  (let (( inst (cdr (assoc ' instance_data  eh))))                                                                    #|line 434|#
    (cond
      (( equal    "filename" (cdr (assoc ' port  msg)))                                                             #|line 435|#
        (setf (cdr (assoc ' filename  inst)) (funcall (cdr (assoc '(cdr (assoc ' srepr  datum))  msg)) ))       #|line 436|#
        )
      (( equal    "input" (cdr (assoc ' port  msg)))                                                                #|line 437|#
        (let ((contents (funcall (cdr (assoc '(cdr (assoc ' srepr  datum))  msg)) )))                           #|line 438|#
          (let (( f (funcall  open   (cdr (assoc ' filename  inst))   "w"                                     #|line 439|#)))
            (cond
              ((not (equal   f  nil))                                                                       #|line 440|#
                (funcall (cdr (assoc ' write  f))   (funcall (cdr (assoc '(cdr (assoc ' srepr  datum))  msg)) ) #|line 441|#)
                (funcall (cdr (assoc ' close  f)) )                                                   #|line 442|#
                (funcall  send    eh   "done"  (funcall  new_datum_bang )   msg )                   #|line 443|#
                )
              (t                                                                                            #|line 444|#
                (funcall  send_string    eh   "✗"   (concatenate 'string  "open error on file " (cdr (assoc ' filename  inst)))   msg )
                Y))))                                                                                       #|line 445|#
        B)))                                                                                                        #|line 446|#
  )
...
(defun stringconcat_instantiate (&optional  reg  owner  name  template_data)                                            #|line 454|#
  (let ((name_with_id (funcall  gensymbol    "stringconcat"                                                           #|line 455|#)))
    (let ((instp (funcall  StringConcat_Instance_Data )))                                                           #|line 456|#
      (return-from stringconcat_instantiate (funcall  make_leaf    name_with_id   owner   instp   stringconcat_handler #|line 457|#))))#|line 458|#
  )
  ...
  (let (( inst (cdr (assoc ' instance_data  eh))))                                                                    #|line 461|#
    (cond
      (( equal    "1" (cdr (assoc ' port  msg)))                                                                    #|line 462|#
        (setf (cdr (assoc ' buffer1  inst)) (funcall  clone_string   (funcall (cdr (assoc '(cdr (assoc ' srepr  datum))  msg)) ) #|line 463|#))
        (setf (cdr (assoc ' count  inst)) (+ (cdr (assoc ' count  inst))  1))                                 #|line 464|#
        (funcall  maybe_stringconcat    eh   inst   msg )                                                   #|line 465|#
        )
      (( equal    "2" (cdr (assoc ' port  msg)))                                                                    #|line 466|#
        (setf (cdr (assoc ' buffer2  inst)) (funcall  clone_string   (funcall (cdr (assoc '(cdr (assoc ' srepr  datum))  msg)) ) #|line 467|#))
        (setf (cdr (assoc ' count  inst)) (+ (cdr (assoc ' count  inst))  1))                                 #|line 468|#
        (funcall  maybe_stringconcat    eh   inst   msg )                                                   #|line 469|#
        B)
      (t                                                                                                            #|line 470|#
        (funcall  runtime_error    (concatenate 'string  "bad msg.port for stringconcat: " (cdr (assoc ' port  msg))) #|line 471|#)#|line 472|#
        Y)))                                                                                                        #|line 473|#
  )
(defun maybe_stringconcat (&optional  eh  inst  msg)                                                                    #|line 475|#
  (cond
    (( and  ( equal    0 (funcall  len   (cdr (assoc ' buffer1  inst)) )) ( equal    0 (funcall  len   (cdr (assoc ' buffer2  inst)) )))#|line 476|#
      (funcall  runtime_error    "something is wrong in stringconcat, both strings are 0 length" )                #|line 477|#
      ))
  (cond
    (( >=  (cdr (assoc ' count  inst))  2)                                                                          #|line 478|#
      (let (( concatenated_string  ""))                                                                         #|line 479|#
        (cond
          (( equal    0 (funcall  len   (cdr (assoc ' buffer1  inst)) ))                                      #|line 480|#
            (setf  concatenated_string (cdr (assoc ' buffer2  inst)))                                     #|line 481|#
            )
          (( equal    0 (funcall  len   (cdr (assoc ' buffer2  inst)) ))                                      #|line 482|#
          ...
          (t                                                                                                  #|line 484|#
            ...
            Y))
        (funcall  send_string    eh   ""   concatenated_string   msg                                        #|line 486|#)
...
(defun shell_out_instantiate (&optional  reg  owner  name  template_data)                                               #|line 495|#
  (let ((name_with_id (funcall  gensymbol    "shell_out"                                                              #|line 496|#)))
    (let ((cmd (funcall (cdr (assoc ' split  shlex))    template_data                                               #|line 497|#)))
      (return-from shell_out_instantiate (funcall  make_leaf    name_with_id   owner   cmd   shell_out_handler    #|line 498|#))))#|line 499|#
  )
(defun shell_out_handler (&optional  eh  msg)                                                                           #|line 501|#
  (let ((cmd (cdr (assoc ' instance_data  eh))))                                                                      #|line 502|#
    (let ((s (funcall (cdr (assoc '(cdr (assoc ' srepr  datum))  msg)) )))                                          #|line 503|#
      (multiple-value-setq ( stdout  stderr) (funcall  run_command    eh   cmd   s                                #|line 504|#))
      (cond
        ((not (equal   stderr  nil))                                                                            #|line 505|#
          (funcall  send_string    eh   "✗"   stderr   msg )                                                #|line 506|#
          )
        (t                                                                                                      #|line 507|#
          (funcall  send_string    eh   ""   stdout   msg )                                                 #|line 508|#
          Y))))                                                                                                 #|line 509|#
  )
(defun string_constant_instantiate (&optional  reg  owner  name  template_data)                                         #|line 511|##|line 512|##|line 513|#
  (let ((name_with_id (funcall  gensymbol    "strconst"                                                           #|line 514|#)))
    (let (( s  template_data))                                                                                  #|line 515|#
      (cond
        ((not (equal   root_project  ""))                                                                     #|line 516|#
          (setf  s (funcall (cdr (assoc ' sub  re))    "_00_"   root_project   s ))                       #|line 517|#
          ))
      (cond
        ((not (equal   root_0D  ""))                                                                        #|line 518|#
          (setf  s (funcall (cdr (assoc ' sub  re))    "_0D_"   root_0D   s ))                          #|line 519|#
          ))
      (return-from string_constant_instantiate (funcall  make_leaf    name_with_id   owner   s   string_constant_handler #|line 520|#))))#|line 521|#
  )
(defun string_constant_handler (&optional  eh  msg)                                                                     #|line 523|#
  (let ((s (cdr (assoc ' instance_data  eh))))                                                                        #|line 524|#
    (funcall  send_string    eh   ""   s   msg                                                                      #|line 525|#))#|line 526|#
  )
...
(defun initialize_component_palette (&optional  root_project  root_0D  diagram_source_files)                            #|line 545|#
  (let ((reg (funcall  make_component_registry )))                                                                    #|line 546|#
    (loop for diagram_source in  diagram_source_files
      do                                                                                                            #|line 547|#
      (let ((all_containers_within_single_file (funcall  json2internal    diagram_source                        #|line 548|#)))
        (funcall  generate_shell_components    reg   all_containers_within_single_file                        #|line 549|#)
        (loop for container in  all_containers_within_single_file
          do                                                                                                #|line 550|#
          (funcall  register_component    reg  (funcall  Template  :name (cdr (assoc 'name  container)) :template_data  container :instantiator  container_instantiator ) )
          ))                                                                                                #|line 551|#
      )
    (funcall  initialize_stock_components    reg                                                                  #|line 552|#)
...
(defun print_error_maybe (&optional  main_container)                                                                    #|line 556|#
  (let ((error_port  "✗"))                                                                                            #|line 557|#
    (let ((err (funcall  fetch_first_output    main_container   error_port                                          #|line 558|#)))
      (cond
        (( and  (not (equal   err  nil)) ( <   0 (funcall  len   (funcall  trimws   (funcall (cdr (assoc ' srepr  err)) ) ) )))#|line 559|#
          (funcall  print    "___ !!! ERRORS !!! ___"                                                         #|line 560|#)
          (funcall  print_specific_output    main_container   error_port   nil )                            #|line 561|#
          ))))                                                                                                    #|line 562|#
  )#|  debugging helpers |#                                                                                               #|line 564|##|line 565|#
(defun dump_outputs (&optional  main_container)                                                                         #|line 566|#
  (funcall  print )                                                                                                   #|line 567|#
  (funcall  print    "___ Outputs ___"                                                                              #|line 568|#)
  (funcall  print_output_list    main_container                                                                   #|line 569|#)#|line 570|#
  )
(defun trace_outputs (&optional  main_container)                                                                        #|line 572|#
  (funcall  print )                                                                                                   #|line 573|#
  (funcall  print    "___ Message Traces ___"                                                                       #|line 574|#)
  (funcall  print_routing_trace    main_container                                                                 #|line 575|#)#|line 576|#
  )
(defun dump_hierarchy (&optional  main_container)                                                                       #|line 578|#
  (funcall  print )                                                                                                   #|line 579|#
  (funcall  print    (concatenate 'string  "___ Hierarchy ___" (funcall  build_hierarchy    main_container ))       #|line 580|#)#|line 581|#
  )
(defun build_hierarchy (&optional  c)                                                                                   #|line 583|#
  (let (( s  ""))                                                                                                     #|line 584|#
    (loop for child in (cdr (assoc ' children  c))
      do                                                                                                            #|line 585|#
      (setf  s  (concatenate 'string  s (funcall  build_hierarchy    child )))                                  #|line 586|#
      )
    (let (( indent  ""))                                                                                          #|line 587|#
...
(defun dump_connections (&optional  c)                                                                                  #|line 593|#
  (funcall  print )                                                                                                   #|line 594|#
  (funcall  print    "___ connections ___"                                                                          #|line 595|#)
  (funcall  dump_possible_connections    c                                                                        #|line 596|#)
  (loop for child in (cdr (assoc ' children  c))
    do                                                                                                          #|line 597|#
    (funcall  print )                                                                                       #|line 598|#
    (funcall  dump_possible_connections    child )                                                        #|line 599|#
    )                                                                                                           #|line 600|#
  )
(defun trimws (&optional  s)                                                                                            #|line 602|#
  #|  remove whitespace from front and back of string |#                                                              #|line 603|#
  (return-from trimws (funcall (cdr (assoc ' strip  s)) ))                                                          #|line 604|##|line 605|#
  )
...
(defun load_error (&optional  s)                                                                                        #|line 614|##|line 615|#
  (funcall  print    s                                                                                              #|line 616|#)
  (funcall  quit )                                                                                                #|line 617|#
  (setf  load_errors  t)                                                                                        #|line 618|##|line 619|#
  )
(defun runtime_error (&optional  s)                                                                                     #|line 621|##|line 622|#
  (funcall  print    s                                                                                              #|line 623|#)
  (funcall  quit )                                                                                                #|line 624|#
  (setf  runtime_errors  t)                                                                                     #|line 625|##|line 626|#
  )
(defun fakepipename_instantiate (&optional  reg  owner  name  template_data)                                            #|line 628|#
  (let ((instance_name (funcall  gensymbol    "fakepipe"                                                              #|line 629|#)))
    (return-from fakepipename_instantiate (funcall  make_leaf    instance_name   owner   nil   fakepipename_handler #|line 630|#)))#|line 631|#
  )
...
(defun fakepipename_handler (&optional  eh  msg)                                                                        #|line 635|##|line 636|#
  ...
  (funcall  send_string    eh   ""   (concatenate 'string  "/tmp/fakepipe"  rand)   msg                         #|line 638|#)#|line 639|#
...
(defun initialize_stock_components (&optional  reg)                                                                     #|line 646|#
  (funcall  register_component    reg  (funcall  Template    "1then2"   nil   deracer_instantiate )                   #|line 647|#)
  (funcall  register_component    reg  (funcall  Template    "?"   nil   probe_instantiate )                        #|line 648|#)
  (funcall  register_component    reg  (funcall  Template    "?A"   nil   probeA_instantiate )                    #|line 649|#)
  (funcall  register_component    reg  (funcall  Template    "?B"   nil   probeB_instantiate )                  #|line 650|#)
  (funcall  register_component    reg  (funcall  Template    "?C"   nil   probeC_instantiate )                #|line 651|#)
  (funcall  register_component    reg  (funcall  Template    "trash"   nil   trash_instantiate )            #|line 652|#)#|line 653|#
  (funcall  register_component    reg  (funcall  Template    "Low Level Read Text File"   nil   low_level_read_text_file_instantiate ) #|line 654|#)
  (funcall  register_component    reg  (funcall  Template    "Ensure String Datum"   nil   ensure_string_datum_instantiate ) #|line 655|#)#|line 656|#
  (funcall  register_component    reg  (funcall  Template    "syncfilewrite"   nil   syncfilewrite_instantiate ) #|line 657|#)
  (funcall  register_component    reg  (funcall  Template    "stringconcat"   nil   stringconcat_instantiate ) #|line 658|#)
  #|  for fakepipe |#                                                                             #|line 659|#
  (funcall  register_component    reg  (funcall  Template    "fakepipename"   nil   fakepipename_instantiate ) #|line 660|#)#|line 661|#
  )                                                                                                                       #|line 663|#
      ...
      (let ((arg  (nth  3 argv)))                                                                                 #|line 667|#
        (let ((main_container_name  (nth  4 argv)))                                                             #|line 668|#
          (let ((diagram_names  (nthcdr  5 (argv))))                                                          #|line 669|#
            (let ((palette (funcall  initialize_component_palette    root_project   root_0D   diagram_names #|line 670|#)))
              (return-from initialize (values undefined undefined))                                       #|line 671|#))))))#|line 672|#
  )
      ...
      (let ((main_container_name (nth  2  env)))                                                                  #|line 677|#
        (let ((diagram_names (nth  3  env)))                                                                    #|line 678|#
          (let ((arg (nth  4  env)))                                                                          #|line 679|#
            (funcall  set_environment    root_of_project   root_of_0D                                       #|line 680|#)
            #|  get entrypoint container |#                                                               #|line 681|#
            (setf  main_container (funcall  get_component_instance    palette   main_container_name :owner  nil #|line 682|#))
            (cond
              (( equal    nil  main_container)                                                        #|line 683|#
                (funcall  load_error    (concatenate 'string  "Couldn't find container with page name "  (concatenate 'string  main_container_name  (concatenate 'string  " in files "  (concatenate 'string  diagram_source_files  "(check tab names, or disable compression?)")))) #|line 687|#)#|line 688|#
                ))
            (cond
              ( show_hierarchy                                                                      #|line 689|#
                (funcall  dump_hierarchy    main_container                                      #|line 690|#)#|line 691|#
                ))
            (cond
              ( show_connections                                                                  #|line 692|#
                (funcall  dump_connections    main_container                                  #|line 693|#)#|line 694|#
                ))
            (cond
              ((not  load_errors)                                                               #|line 695|#
                (setf  arg (funcall  new_datum_string    arg                                #|line 696|#))
                (setf  msg (funcall  make_message    ""   arg                             #|line 697|#))
                (funcall  inject    main_container   msg                                #|line 698|#)
                (cond
                  ( show_all_outputs                                                  #|line 699|#
                    (funcall  dump_outputs    main_container                      #|line 700|#)
                    )
                  (t                                                                  #|line 701|#
                    (funcall  print_error_maybe    main_container                 #|line 702|#)
                    (funcall  print_specific_output    main_container :port  "" :stderr  False #|line 703|#)
                    (cond
                      ( show_traces                                           #|line 704|#
                        (funcall  print    "--- routing traces ---"       #|line 705|#)
                        (funcall  print   (funcall  routing_trace_all    main_container ) #|line 706|#)#|line 707|#
                        ))                                                    #|line 708|#
                    Y))
                (cond
                  ( show_all_outputs                                                #|line 709|#
                    (funcall  print    "--- done ---"                           #|line 710|#)#|line 711|#
                    ))                                                              #|line 712|#
                )))))))                                                                         #|line 713|#
  )                                                                                                                       #|line 715|##|line 716|##|  utility functions  |##|line 717|#
(defun send_int (&optional  eh  port  i  causing_message)                                                               #|line 718|#
  (let ((datum (funcall  new_datum_int    i                                                                           #|line 719|#)))
    (funcall  send    eh   port   datum   causing_message                                                           #|line 720|#))#|line 721|#
  )
(defun send_bang (&optional  eh  port  causing_message)                                                                 #|line 723|#
  (let ((datum (funcall  new_datum_bang )))                                                                           #|line 724|#
    (funcall  send    eh   port   datum   causing_message                                                           #|line 725|#))#|line 726|#
  )

...
(defun log_send (&optional  sender  sender_port  msg  cause_msg)                                                        #|line 260|#
  (let ((send_desc (make_Send_Descriptor   :component  sender :port  sender_port :message  msg :cause_port (cdr (assoc ' port  cause_msg)) :cause_message  cause_msg #|line 261|#)))
    (append_routing_descriptor   :container (cdr (assoc ' owner  sender)) :desc  send_desc                          #|line 262|#))#|line 263|#
  )
(defun log_send_string (&optional  sender  sender_port  msg  cause_msg)                                                 #|line 265|#
  (let ((send_desc (make_Send_Descriptor     sender   sender_port   msg  (cdr (assoc ' port  cause_msg))   cause_msg  #|line 266|#)))
    (append_routing_descriptor   :container (cdr (assoc ' owner  sender)) :desc  send_desc                          #|line 267|#))#|line 268|#
  )
...
(defun deposit (&optional  parent  conn  message)                                                                       #|line 659|#
  (let ((new_message (make_message   :port (cdr (assoc '(cdr (assoc ' port  receiver))  conn)) :datum (cdr (assoc ' datum  message)) #|line 660|#)))
    ...
    (push_message     parent  (cdr (assoc '(cdr (assoc ' component  receiver))  conn))  (cdr (assoc '(cdr (assoc ' queue  receiver))  conn))   new_message #|line 662|#))#|line 663|#
  )
    ...
    (let (( fromname  ""))                                                                                        #|line 748|#
      (cond
        ...
        (t                                                                                                      #|line 753|#
          ...
          (let ((from_sender (Sender   :name  fromname :component  from_component :port (cdr (assoc ' port  message)) #|line 756|#)))#|line 757|#
...
(defun print_routing_trace (&optional  eh)                                                                              #|line 789|#
  (print    (routing_trace_all     eh )                                                                               #|line 790|#)#|line 791|#
  )
...
(defun log_connection (&optional  container  connector  message)                                                        #|line 797|#
  (cond
    (( equal    "down" (cdr (assoc ' direction  connector)))                                                          #|line 798|#
      (log_down   :container  container                                                                           #|line 799|#:source_port (cdr (assoc '(cdr (assoc ' port  sender))  connector)) #|line 800|#:source_message  nil #|line 801|#:target (cdr (assoc '(cdr (assoc ' component  receiver))  connector)) #|line 802|#:target_port (cdr (assoc '(cdr (assoc ' port  receiver))  connector)) #|line 803|#:target_message  message )#|line 804|#
      )
    (( equal    "up" (cdr (assoc ' direction  connector)))                                                            #|line 805|#
      (log_up   :source (cdr (assoc '(cdr (assoc ' component  sender))  connector)) :source_port (cdr (assoc '(cdr (assoc ' port  sender))  connector)) :source_message  nil :container  container :target_port (cdr (assoc '(cdr (assoc ' port  receiver))  connector)) #|line 806|#:target_message  message )#|line 807|#
      )
    (( equal    "across" (cdr (assoc ' direction  connector)))                                                        #|line 808|#
      (log_across   :container  container                                                                         #|line 809|#:source (cdr (assoc '(cdr (assoc ' component  sender))  connector)) :source_port (cdr (assoc '(cdr (assoc ' port  sender))  connector)) :source_message  nil #|line 810|#:target (cdr (assoc '(cdr (assoc ' component  receiver))  connector)) :target_port (cdr (assoc '(cdr (assoc ' port  receiver))  connector)) :target_message  message )#|line 811|#
      )
    (( equal    "through" (cdr (assoc ' direction  connector)))                                                       #|line 812|#
      (log_through   :container  container :source_port (cdr (assoc '(cdr (assoc ' port  sender))  connector)) :source_message  nil #|line 813|#:target_port (cdr (assoc '(cdr (assoc ' port  receiver))  connector)) :message  message )#|line 814|#
      )
    (t                                                                                                                #|line 815|#

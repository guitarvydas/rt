...
class Template:
    def __init__ (self,name,template_data,instantiator):                        #line 8
        ...
        self.instantiator =  instantiator                                       #line 11
                                                                                #line 12
...
def make_component_registry ():                                                 #line 28
    ...
    return Component_Registry ()                                                #line 29
                                                                                #line 30
...
def register_component_allow_overwriting (reg,template):
    return abstracted_register_component ( reg, template, True)                 #line 33
...
def calculate_depth (eh):                                                       #line 70
    ...
    if  eh. owner ==  None:                                                     #line 71
        ...
        return  1+calculate_depth ( eh. owner)                                  #line 74
...
def print_stats (reg):                                                          #line 86
 print ( str( "registry statistics: ") +  reg. stats )                          #line 87
                                                                                #line 88
        ...
        for diagram in  container_list:                                         #line 101
            ...
            for child_descriptor in  diagram ["children"]:                      #line 104
                ...
                if first_char_is ( child_descriptor ["name"], "$"):             #line 105
                    ...
                    register_component_allow_overwriting ( reg, generated_leaf) #line 114
                                                                                #line 115
...
def first_char_is (s,c):                                                        #line 125
    ...
    return  c == first_char ( s)                                                #line 126
                                                                                #line 127
...
def run_command (eh,cmd,s):                                                     #line 131
    ...
    if not ( ret. returncode ==  0):                                            #line 134
        ...
        return [ ret. stdout, None]                                             #line 140
...
class Eh:
    def __init__ (self,):                                                       #line 159
        ...
        self.state =  "idle"                                                    #line 172
        # bootstrap debugging                                                   #line 173
        ...
        self.depth =  0 # hierarchical depth of component, 0=top, 1=1st child of top, 2=1st child of 1st child of top, etc.#line 176
                                                                                #line 177
...
# that will be passed back to your handler when called.                         #line 193
                                                                                #line 194
...
# of the given component.                                                       #line 207
                                                                                #line 208
...
def print_output_list (eh):                                                     #line 237
    ...
    for m in list ( eh. outq. queue):                                           #line 238
     print (format_message ( m))                                                #line 239
...
def set_idle (eh):                                                              #line 253
    ...
    eh. state =  "idle"                                                         #line 254
                                                                                #line 255

                                                                                #line 256
# Utility for printing a specific output message.                               #line 257
                                                                                #line 258
...
def print_specific_output_to_stderr (eh,port):                                  #line 271
    ...
    print ( datum.srepr (), file=sys.stderr)                                    #line 275
                                                                                #line 276
...
def probe_instantiate (reg,owner,name,template_data):                           #line 302
    ...
    return make_leaf ( name_with_id, owner, None, probe_handler)                #line 304
                                                                                #line 305
...
def probeA_instantiate (reg,owner,name,template_data):                          #line 306
    ...
    return make_leaf ( name_with_id, owner, None, probe_handler)                #line 308
                                                                                #line 309
...
def probeB_instantiate (reg,owner,name,template_data):                          #line 311
    ...
    return make_leaf ( name_with_id, owner, None, probe_handler)                #line 313
                                                                                #line 314
...
def probeC_instantiate (reg,owner,name,template_data):                          #line 316
    ...
    return make_leaf ( name_with_id, owner, None, probe_handler)                #line 318
                                                                                #line 319
...
def probe_handler (eh,msg):                                                     #line 321
    ...
    # print_stdout  >>>  error - unrecognized external (with given arguments)  <<<  (#strcons("... probe ",#strcons(eh.name,#strcons(": ",s))),sys.stderr) #line 323
                                                                                #line 324
...
def trash_instantiate (reg,owner,name,template_data):                           #line 326
    ...
    return make_leaf ( name_with_id, owner, None, trash_handler)                #line 328
                                                                                #line 329
...
def send_first_then_second (eh,inst):                                           #line 358
    ...
    reclaim_Buffers_from_heap ( inst)                                           #line 361
                                                                                #line 362
...
def deracer_handler (eh,msg):                                                   #line 364
    ...
    if  inst. state ==  "idle":                                                 #line 366
        ...
        runtime_error ( "bad state for deracer {eh.state}")                     #line 390
...
def low_level_read_text_file_instantiate (reg,owner,name,template_data):        #line 393
    ...
    return make_leaf ( name_with_id, owner, None, low_level_read_text_file_handler)#line 395
                                                                                #line 396
...
def ensure_string_datum_instantiate (reg,owner,name,template_data):             #line 403
    ...
    return make_leaf ( name_with_id, owner, None, ensure_string_datum_handler)  #line 405
                                                                                #line 406
...
def ensure_string_datum_handler (eh,msg):                                       #line 408
    ...
    if  "string" ==  msg. datum.kind ():                                        #line 409
        ...
        send_string ( eh, "✗", emsg, msg)                                       #line 413
...
def syncfilewrite_instantiate (reg,owner,name,template_data):                   #line 421
    ...
    return make_leaf ( name_with_id, owner, inst, syncfilewrite_handler)        #line 424
                                                                                #line 425
...
def stringconcat_instantiate (reg,owner,name,template_data):                    #line 448
    ...
    return make_leaf ( name_with_id, owner, instp, stringconcat_handler)        #line 451
                                                                                #line 452
...
def stringconcat_handler (eh,msg):                                              #line 454
    ...
    if  "1" ==  msg. port:                                                      #line 456
        ...
        runtime_error ( str( "bad msg.port for stringconcat: ") +  msg. port )  #line 465
                                                                                #line 466
...
def shell_out_instantiate (reg,owner,name,template_data):                       #line 489
    ...
    return make_leaf ( name_with_id, owner, cmd, shell_out_handler)             #line 492
                                                                                #line 493
...
def shell_out_handler (eh,msg):                                                 #line 495
    ...
    if  stderr!= None:                                                          #line 501
        ...
        send_string ( eh, "", stdout, msg)                                      #line 504
...
def string_constant_instantiate (reg,owner,name,template_data):                 #line 507
    ...
    return make_leaf ( name_with_id, owner, s, string_constant_handler)         #line 516
                                                                                #line 517
...
# where ${_0D_} is the root directory for 0D (e.g. 0D/odin or 0D/python)        #line 535
                                                                                #line 536
                                                                                #line 537
                                                                                #line 538
...
def print_error_maybe (main_container):                                         #line 550
    ...
    if ( err!= None) and ( 0 < len (trimws ( err.srepr ()))):                   #line 553
     print ( "___ !!! ERRORS !!! ___")                                          #line 554
        ...
        print_specific_output ( main_container, error_port, False)              #line 555

                                                                                #line 556

                                                                                #line 557
# debugging helpers                                                             #line 558
                                                                                #line 559
...
def dump_outputs (main_container):                                              #line 564
    ...
    print_output_list ( main_container)                                         #line 567
                                                                                #line 568
...
def trace_outputs (main_container):                                             #line 570
    ...
    print_routing_trace ( main_container)                                       #line 573
                                                                                #line 574
...
def dump_hierarchy (main_container):                                            #line 576
    ...
    nl ()                                                                       #line 577
    print ( str( "___ Hierarchy ___") + (build_hierarchy ( main_container)) )   #line 578
                                                                                #line 579
...
def build_hierarchy (c):                                                        #line 581
    ...
    return  str( "\n") +  str( indent) +  str( "(") +  str( c. name) +  str( s) +  ")"     #line 588
                                                                                #line 589
...
def dump_connections (c):                                                       #line 591
    ...
    for child in  c. children:                                                  #line 595
        ...
        dump_possible_connections ( child)                                      #line 597
...
def fakepipename_instantiate (reg,owner,name,template_data):                    #line 626
    ...
    return make_leaf ( instance_name, owner, None, fakepipename_handler)        #line 628
                                                                                #line 629
...
def fakepipename_handler (eh,msg):                                              #line 633
    ...
    send_string ( eh, "", str( "/tmp/fakepipe") +  rand , msg)                  #line 636
                                                                                #line 637

                                                                                #line 638
                                                                                #line 639
# all of the the built_in leaves are listed here                                #line 640
# future: refactor this such that programmers can pick and choose which (lumps of) builtins are used in a specific project#line 641
                                                                                #line 642
                                                                                #line 643
...
def initialize_stock_components (reg):                                          #line 644
    ...
    register_component ( reg,Template ( "trash", None, trash_instantiate))      #line 650
                                                                                #line 651

    register_component ( reg,Template ( "Low Level Read Text File", None, low_level_read_text_file_instantiate))#line 652

    register_component ( reg,Template ( "Ensure String Datum", None, ensure_string_datum_instantiate))#line 653
                                                                                #line 654
    ...
    register_component ( reg,Template ( "fakepipename", None, fakepipename_instantiate))#line 658
                                                                                #line 659
...
def initialize ():                                                              #line 665
    ...
    return [ palette,[ root_of_project, root_of_0D, main_container_name, diagram_names, arg]]#line 672
                                                                                #line 673
...
def start_with_debug (palette,env,show_hierarchy,show_connections,show_traces,show_all_outputs):#line 676
    ...
    if  None ==  main_container:                                                #line 686
        ...
        load_error ( str( "Couldn't find container with page name ") +  str( main_container_name) +  str( " in files ") +  str( diagram_names) +  "(check tab names, or disable compression?)"    )#line 690
                                                                                #line 691


    if  show_hierarchy:                                                         #line 692

        dump_hierarchy ( main_container)                                        #line 693
                                                                                #line 694


    if  show_connections:                                                       #line 695

        dump_connections ( main_container)                                      #line 696
                                                                                #line 697
        ...
        if  show_all_outputs:                                                   #line 702
            ...
            if  show_traces:                                                    #line 707
             print ( "--- routing traces ---")                                  #line 708
                print (routing_trace_all ( main_container))                     #line 709
                                                                                #line 710
...
def send_int (eh,port,i,causing_message):                                       #line 721
    ...
    send ( eh, port, datum, causing_message)                                    #line 723
                                                                                #line 724
...
def send_bang (eh,port,causing_message):                                        #line 726
    ...
    send ( eh, port, datum, causing_message)                                    #line 728
                                                                                #line 729

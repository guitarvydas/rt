...
def create_down_connector (container,proto_conn,connectors,children_by_id):#line 129
    ...
    print (f'create down {connector.direction} {connector.sender} {connector.receiver} {proto_conn}')
...
def container_instantiator (reg,owner,container_name,desc): #line 185
    ...
    print (f'container instantiator {container.name} {container.children} {container.connections}')
...
def mkSender (name,component,port):                         #line 260
    ...
    print (f'mkSender {s.name} {s.component} {s.port}')
...
def sender_eq (s1,s2):                                      #line 279
    ...
    print (f'sender_eq portseq={same_ports} /{s1.port}/ /{s2.port}/ ; comp={same_components}  /{s1.component}/ /{s2.component}/')
...
def is_self (child,container):                              #line 303
    ...
    print (f'is_self {child == container} {child} {container}') 
...
def route (container,from_component,message):               #line 371
    ...
    if is_tick ( message):                                  #line 374
        ...
        print (f'route begin')
        print (f'  from: name {from_sender.name}  component={from_sender.component}  port={from_sender.port}')
        for connector in  container.connections:            #line 386
            print (f'route trying {connector.sender} {connector.sender.port}')
            if sender_eq ( from_sender, connector.sender):  #line 387
                print (f'route *** depositing {connector}')

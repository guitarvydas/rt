...
def abstracted_register_component (reg,template,ok_to_overwrite):#line 35
    ...
    if ( name in  reg.templates) and not  ok_to_overwrite:  #line 37
        ...
        reg.insert (NIY ( "templates", NIY ( name,  template)))#line 41
        ...
        for diagram in  container_list:                     #line 100
            ...
            for child_descriptor in  diagram [ "children"]: #line 103
                if first_char_is ( child_descriptor [ "name"], "$"):#line 104
                    ...
                    regkvs.insert (register_component ( regkvs, generated_leaf))#line 108
                    ...
                    regkvs.insert (register_component_allow_overwriting ( regkvs, generated_leaf))#line 113#line 114#line 115#line 116#line 117
    return  regkvs                                          #line 118#line 119#line 120
...
def initialize_component_palette (root_project,root_0D,diagram_source_files):#line 522
    ...
    for diagram_source in  diagram_source_files:            #line 524
        ...
        for container in  all_containers_within_single_file:#line 527
            reg.insert (register_component ( reg,Template ( container [ "name"], container, container_instantiator)))#line 528#line 529#line 530
...
def initialize_stock_components (reg):                      #line 597
    regkvs = register_component ( reg,Template ( "1then2", None, deracer_instantiate))#line 598
    regkvs.insert (register_component ( regkvs,Template ( "?", None, probe_instantiate)))#line 599
    regkvs.insert (register_component ( regkvs,Template ( "?A", None, probeA_instantiate)))#line 600
    regkvs.insert (register_component ( regkvs,Template ( "?B", None, probeB_instantiate)))#line 601
    regkvs.insert (register_component ( regkvs,Template ( "?C", None, probeC_instantiate)))#line 602
    regkvs.insert (register_component ( regkvs,Template ( "trash", None, trash_instantiate)))#line 603#line 604
    regkvs.insert (register_component ( regkvs,Template ( "Low Level Read Text File", None, low_level_read_text_file_instantiate)))#line 605
    regkvs.insert (register_component ( regkvs,Template ( "Ensure String Datum", None, ensure_string_datum_instantiate)))#line 606#line 607
    regkvs.insert (register_component ( regkvs,Template ( "syncfilewrite", None, syncfilewrite_instantiate)))#line 608
    regkvs.insert (register_component ( regkvs,Template ( "stringconcat", None, stringconcat_instantiate)))#line 609
    # for fakepipe                                          #line 610
    regkvs.insert (register_component ( regkvs,Template ( "fakepipename", None, fakepipename_instantiate)))#line 611
    return  regkvs                                          #line 612#line 613#line 614

...
def raw_datum_string (d):                                                       #line 63
    ...
    return bytearray ( d. data, "UTF_8")                                        #line 64
                                                                                #line 65
...
def srepr_datum_bytes (d):                                                      #line 137
    ...
    return  d. data.decode ( "UTF_8")                                           #line 138
                                                                                #line 139


def raw_datum_bytes (d):                                                        #line 140

    return  d. data                                                             #line 141
                                                                                #line 142
...
def new_datum_handle (h):                                                       #line 144
    ...
    return new_datum_int ( h)                                                   #line 145
                                                                                #line 146
...
def clone_port (s):                                                             #line 185
    ...
    return clone_string ( s)                                                    #line 186
                                                                                #line 187
...
def format_message (m):                                                         #line 218
    ...
    if  m ==  None:                                                             #line 219
        ...
        return  str( "⟪") +  str( m. port) +  str( "⦂") +  str( m. datum.srepr ()) +  "⟫"    #line 225
                                                                                #line 226
...
# purposes, or for reading by other tools.                                      #line 311
                                                                                #line 312
...
class Connector:
    def __init__ (self,):                                                       #line 313
        ...
        self.receiver =  None                                                   #line 316
                                                                                #line 317

                                                                                #line 318
# `Sender` is used to “pattern match“ which `Receiver` a message should go to,  #line 319
# based on component ID (pointer) and port name.                                #line 320
                                                                                #line 321
...
class Sender:
    def __init__ (self,name,component,port):                                    #line 322
        ...
        self.port =  port # from's port                                         #line 325
                                                                                #line 326

                                                                                #line 327
# `Receiver` is a handle to a destination queue, and a `port` name to assign    #line 328
# to incoming messages to this queue.                                           #line 329
                                                                                #line 330
...
class Receiver:
    def __init__ (self,name,queue,port,component):                              #line 331
        ...
        self.component =  component # to (for bootstrap debug)                  #line 335
                                                                                #line 336
...
def sender_eq (s1,s2):                                                          #line 339
    ...
    return  same_components and  same_ports                                     #line 342
                                                                                #line 343

                                                                                #line 344
# Delivers the given message to the receiver of this connector.                 #line 345
                                                                                #line 346
...
def deposit (parent,conn,message):                                              #line 347
    ...
    push_message ( parent, conn. receiver. component, conn. receiver. queue, new_message)#line 349
                                                                                #line 350
...
def push_message (parent,receiver,inq,m):                                       #line 358
    ...
    parent. visit_ordering.put ( receiver)                                      #line 360
                                                                                #line 361
...
def is_self (child,container):                                                  #line 363
    ...
    return  child ==  container                                                 #line 365
                                                                                #line 366
...
def step_child (child,msg):                                                     #line 368
    ...
    return [ before_state ==  "idle" and  after_state!= "idle",                 #line 372
    before_state!= "idle" and  after_state!= "idle",                            #line 373
    before_state!= "idle" and  after_state ==  "idle"]                          #line 374
                                                                                #line 375
...
def save_message (eh,msg):                                                      #line 377
    ...
    eh. saved_messages.put ( msg)                                               #line 378
                                                                                #line 379
...
def fetch_saved_message_and_clear (eh):                                         #line 381
    ...
    return  eh. saved_messages.get ()                                           #line 382
                                                                                #line 383
    ...
    for child in list ( container. visit_ordering. queue):                      #line 387
        ...
        if (not (is_self ( child, container))):                                 #line 389
            ...
            if  child. state ==  "active":                                      #line 408
                ...
                container. state =  "active"                                    #line 410
...
def is_tick (msg):                                                              #line 425
    ...
    return  "tick" ==  msg. datum.kind ()                                       #line 426
                                                                                #line 427

                                                                                #line 428
# Routes a single message to all matching destinations, according to            #line 429
# the container's connection network.                                           #line 430
                                                                                #line 431
...
def route (container,from_component,message):                                   #line 432
    ...
    if is_tick ( message):                                                      #line 435
        ...
        from_sender = Sender ( fromname, from_component, message. port)         #line 442
                                                                                #line 443
...
def dump_possible_connections (container):                                      #line 458
    ...
    for connector in  container. connections:                                   #line 460
        ...
        print ( str( connector. direction) +  str( " ") +  str( connector. sender. name) +  str( ".") +  str( connector. sender. port) +  str( " -> ") +  str( connector. receiver. name) +  str( ".") +  connector. receiver. port        )#line 461
...
def child_is_ready (eh):                                                        #line 471
    ...
    return (not ( eh. outq.empty ())) or (not ( eh. inq.empty ())) or ( eh. state!= "idle") or (any_child_ready ( eh))#line 472
                                                                                #line 473
...
def print_routing_trace (eh):                                                   #line 475
    ...
    print (routing_trace_all ( eh))                                             #line 476
                                                                                #line 477
...
def append_routing_descriptor (container,desc):                                 #line 479
    ...
    container. routings.put ( desc)                                             #line 480
                                                                                #line 481
...
def container_injector (container,message):                                     #line 483
    ...
    container_handler ( container, message)                                     #line 484
                                                                                #line 485

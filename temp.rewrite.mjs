...
enter_rule ("Defn");
    ...
    set_return (`\n(defun ${ident.rwr ()} (&optional ${Formals.rwr ()})${StatementBlock.rwr ()})`);
...
enter_rule ("Defsynonym_legal");
    set_return (`\n(let ((undefined ${e.rwr ()}))⤷${rec.rwr ().join ('')}⤶)`);
...
enter_rule ("ReturnExp_multiple");
    set_return (`(values undefined undefined)${rec.rwr ().join ('')}`);
...
Primary_pmacro : function (m,) {
enter_rule ("Primary_pmacro");
    set_return (`${m.rwr ()}`);
return exit_rule ("Primary_pmacro");
},
...
Pmacro_fresh : function (_83,_84,ident,_85,) {
enter_rule ("Pmacro_fresh");
    set_return (` (${ident.rwr ()})`);
return exit_rule ("Pmacro_fresh");
},
Pmacro_car : function (_83,_84,e,_85,) {
enter_rule ("Pmacro_car");
    set_return (` (car ${e.rwr ()})`);
return exit_rule ("Pmacro_car");
},
Pmacro_cdr : function (_83,_84,e,_85,) {
enter_rule ("Pmacro_cdr");
    set_return (` (cdr ${e.rwr ()})`);
return exit_rule ("Pmacro_cdr");
},
Pmacro_nthargvcdr : function (_83,lb,n,rb,) {
enter_rule ("Pmacro_nthargvcdr");
    set_return (` (nthcdr ${n.rwr ()} (argv))`);
return exit_rule ("Pmacro_nthargvcdr");
},
Pmacro_nthargv : function (_83,_84,n,_85,) {
enter_rule ("Pmacro_nthargv");
    set_return (` (nth ${n.rwr ()} argv)`);
return exit_rule ("Pmacro_nthargv");
},
Pmacro_stringcdr : function (_83,_84,e,_85,) {
enter_rule ("Pmacro_stringcdr");
    set_return (` (subseq ${e.rwr ()} 1)`);
return exit_rule ("Pmacro_stringcdr");
},
Pmacro_strcons : function (_strcons,lp,e1,_comma,e2,rp,) {
enter_rule ("Pmacro_strcons");
    set_return (` (concatenate 'string ${e1.rwr ()} ${e2.rwr ()})`);
return exit_rule ("Pmacro_strcons");
},
...
Atom_listconst : function (_74,line1,PrimaryComma,_75,line2,) {
enter_rule ("Atom_listconst");
    set_return (`(list ${line1.rwr ().join ('')} ${PrimaryComma.rwr ().join ('')})${line2.rwr ()}`);
...
ActualComma : function (Actual,comma,line,) {
...
enter_rule ("Pair");
    set_return (`(setf (gethash ${string.rwr ()} ${getParameter ("freshdict")}) ⤷${Exp.rwr ()}⤶))`);

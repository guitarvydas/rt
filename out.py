...
def ensure_string_datum_handler (eh,mev):              #line 116
    if  "string" ==  mev.datum.kind ():                #line 117
        ...
        send ( eh, "✗", emev, mev)                     #line 121#line 122#line 123#line 124
...
def syncfilewrite_handler (eh,mev):                    #line 136
    ...
    if  "filename" ==  mev.port:                       #line 138
        ...
        if  f!= None:                                  #line 143
            ...
            send ( eh, "✗", str( "open error on file ") +  inst.filename , mev)#line 148#line 149#line 150#line 151#line 152
...
def fakepipename_handler (eh,mev):                     #line 220
    ...
    send ( eh, "", str( "/tmp/fakepipe") +  rand , mev)#line 223#line 224#line 225
                                                       #line 226
...
class StringAccumulator:
    def __init__ (self,):                              #line 256
        self.s =  ""                                   #line 257#line 258
                                                       #line 259
def strcatstar_instantiate (reg,owner,name,template_data):#line 260
    name_with_id = gensymbol ( "String Concat *")      #line 261
    instp =  StringAccumulator ()                      #line 262
    return make_leaf ( name_with_id, owner, instp, strcatstar_handler)#line 263#line 264#line 265

def strcatstar_handler (eh,mev):                       #line 266
    accum =  eh.instance_data                          #line 267
    if  "" ==  mev.port:                               #line 268
        accum.s =  str( accum.s) +  mev.datum.v        #line 269
    elif  "fini" ==  mev.port:                         #line 270
        send ( eh, "", accum.s, mev)                   #line 271
    else:                                              #line 272
        send ( eh, "✗", "internal error bad mevent for String Concat *", mev)#line 273#line 274#line 275#line 276
...
def initialize_stock_components (reg):                 #line 280
    register_component ( reg,mkTemplate ( "1then2", None, deracer_instantiate))#line 281
    register_component ( reg,mkTemplate ( "?A", None, probeA_instantiate))#line 282
    register_component ( reg,mkTemplate ( "?B", None, probeB_instantiate))#line 283
    register_component ( reg,mkTemplate ( "?C", None, probeC_instantiate))#line 284
    register_component ( reg,mkTemplate ( "trash", None, trash_instantiate))#line 285#line 286#line 287
    register_component ( reg,mkTemplate ( "Read Text File", None, low_level_read_text_file_instantiate))#line 288
    register_component ( reg,mkTemplate ( "Ensure String Datum", None, ensure_string_datum_instantiate))#line 289#line 290
    register_component ( reg,mkTemplate ( "syncfilewrite", None, syncfilewrite_instantiate))#line 291
    register_component ( reg,mkTemplate ( "stringconcat", None, stringconcat_instantiate))#line 292
    register_component ( reg,mkTemplate ( "switch1*", None, switch1star_instantiate))#line 293
    register_component ( reg,mkTemplate ( "String Concat *", None, strcatstar_instantiate))#line 294
    # for fakepipe                                     #line 295
    register_component ( reg,mkTemplate ( "fakepipename", None, fakepipename_instantiate))#line 296#line 297#line 298#
import sys
import re
import subprocess
import shlex

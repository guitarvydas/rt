...
# `datum` is the data attached to this mevent.             #line 74
class Mevent:
    def __init__(self):
        self.port =  None
        self.datum =  None
    ...
    def __eq__(self, other):
        if not isinstance(other, Mevent):
            return NotImplemented
        port_equal = self.port == other.port
        datum_equal = self.datum == other.datum
        return port_equal and datum_equal
    
    def __repr__(self):
        return '{"' + self.port + '": "' + self.datum.v + '"}'
...
def deque_to_json(d):
    ...
    # print (f'deque_to_json /{ordered_list}/')
    return json.dumps(ordered_list, indent=2)
    #return '[{"Python":"deque2j"}]'
...
def format_mevent (m):                                     #line 117
    if  m ==  None:                                         #line 118
        ...
        return  str( '{"port":"') +  str( m.port) +  str('", "payload":"') +  str( m.datum.v) +  '"}'    #line 121#line 122#line 123#line 124
def format_mevent_raw (m):                                     #line 117
    if  m ==  None:                                         #line 118
        return '""'
    else:                                                   #line 120
        return  str( m.datum.v)
...
def container_handler (container,mevent):                  #line 219
    ...
    while any_child_ready ( container):                     #line 221
        step_children ( container, mevent)                 #line 222#line 223#line 224
...
# no affect on the default mevent routing system _ it is there for debugging#line 231
...
class Connector:
    def __init__ (self,):                                   #line 234
        ...
        self.receiver =  None                               #line 237#line 238
                                                            #line 239
# `Sender` is used to “pattern match“ which `Receiver` a mevent should go to,#line 240
...
# to incoming mevents to this queue.                       #line 252#line 253
class Receiver:
...
# Delivers the given mevent to the receiver of this connector.#line 286#line 287
def deposit (parent,conn,mevent):                          #line 288
    new_mevent = make_mevent ( conn.receiver.port, mevent.datum)#line 289
    push_mevent ( parent, conn.receiver.component, conn.receiver.queue, new_mevent)#line 290#line 291#line 292

def force_tick (parent,eh):                                 #line 293
    tick_mev = make_mevent ( ".",new_datum_bang ())        #line 294
    push_mevent ( parent, eh, eh.inq, tick_mev)            #line 295
    return  tick_mev                                        #line 296#line 297#line 298

def push_mevent (parent,receiver,inq,m):                   #line 299
...
def step_child (child,mev):                                 #line 309
    before_state =  child.state                             #line 310
    child.handler ( child, mev)                             #line 311
...
def step_children (container,causingMevent):               #line 318
    ...
    for child in  list ( container.visit_ordering):         #line 320
        ...
        if (not (is_self ( child, container))):             #line 322
            if (not ((0==len( child.inq)))):                #line 323
                mev =  child.inq.popleft ()                 #line 324
                began_long_run =  None                      #line 325
                continued_long_run =  None                  #line 326
                ended_long_run =  None                      #line 327
                [ began_long_run, continued_long_run, ended_long_run] = step_child ( child, mev)#line 328
                ...
                destroy_mevent ( mev)                      #line 336
            else:                                           #line 337
                if  child.state!= "idle":                   #line 338
                    mev = force_tick ( container, child)    #line 339
                    child.handler ( child, mev)             #line 340
                    destroy_mevent ( mev)                  #line 341#line 342#line 343#line 344
            ...
            while (not ((0==len( child.outq)))):            #line 350
                mev =  child.outq.popleft ()                #line 351
                route ( container, child, mev)              #line 352
                destroy_mevent ( mev)                      #line 353#line 354#line 355#line 356#line 357#line 358

def attempt_tick (parent,eh):                               #line 359
    if  eh.state!= "idle":                                  #line 360
        force_tick ( parent, eh)                            #line 361#line 362#line 363#line 364

def is_tick (mev):                                          #line 365
    return  "." ==  mev.port
    # assume that any mevent that is sent to port "." is a tick #line 366#line 367#line 368

# Routes a single mevent to all matching destinations, according to#line 369
# the container's connection network.                       #line 370#line 371
def route (container,from_component,mevent):               #line 372
    was_sent =  False
    ...
    if is_tick ( mevent):                                  #line 377
        ...
        from_sender = mkSender ( fromname, from_component, mevent.port)#line 387#line 388
        for connector in  container.connections:            #line 389
            if sender_eq ( from_sender, connector.sender):  #line 390
                deposit ( container, connector, mevent)    #line 391
                was_sent =  True                            #line 392#line 393#line 394#line 395
    if not ( was_sent):                                     #line 396
        print ( "\n\n*** Error: ***")                       #line 397
        print ( "***")                                      #line 398
        print ( str( container.name) +  str( ": mevent '") +  str( mevent.port) +  str( "' from ") +  str( fromname) +  " dropped on floor..."     )#line 399
        print ( "***")                                      #line 400
...
def container_injector (container,mevent):                 #line 422
    container_handler ( container, mevent)                 #line 423#line 424#line 425
...
# and output queues of mevents.                            #line 524
#                                                           #line 525
# Components can either be a user_supplied function (“lea“), or a “container“#line 526
# that routes mevents to child components according to a list of connections#line 527
# that serve as a mevent routing table.                    #line 528
#                                                           #line 529
...
# Sends a mevent on the given `port` with `data`, placing it on the output#line 583
# of the given component.                                   #line 584#line 585
def send (eh,port,datum,causingMevent):                    #line 586
    mev = make_mevent ( port, datum)                       #line 587
    put_output ( eh, mev)                                   #line 588#line 589#line 590

def send_string (eh,port,s,causingMevent):                 #line 591
    datum = new_datum_string ( s)                           #line 592
    mev = make_mevent ( port, datum)                       #line 593
    put_output ( eh, mev)                                   #line 594#line 595#line 596

def forward (eh,port,mev):                                  #line 597
    fwdmev = make_mevent ( port, mev.datum)                #line 598
    put_output ( eh, fwdmev)                                #line 599#line 600#line 601

def inject (eh,mev):                                        #line 602
    eh.finject ( eh, mev)                                   #line 603#line 604#line 605
...
# Utility for printing a specific output mevent.           #line 637#line 638
def fetch_first_output (eh,port):                           #line 639
    for mev in  list ( eh.outq):                            #line 640
        if ( mev.port ==  port):                            #line 641
            return  mev.datum                               #line 642
...
def put_output (eh,mev):                                    #line 658
    eh.outq.append ( mev)                                   #line 659#line 660#line 661
...
def start (palette,env):
    ...
    if not  load_errors:                                    #line 777
        ...
        mev = make_mevent ( "", marg)                      #line 779
        inject ( main_container, mev)                       #line 780
        print (deque_to_json (main_container.outq))
    live_update ("Live", "...end")
...
def send_int (eh,port,i,causing_mevent):                   #line 800
    datum = new_datum_string (str ( i))                     #line 801
    send ( eh, port, datum, causing_mevent)                #line 802#line 803#line 804

def send_bang (eh,port,causing_mevent):                    #line 805
    datum = new_datum_bang ()                               #line 806
    send ( eh, port, datum, causing_mevent)                #line 807#line 808
...
def probe_handler (eh,mev):                                 #line 16
    ...
    live_update ("Live", s)
    #print ('[{Error:"' + s[s.rindex('▹')+1:] + scontinued + '}]', file=sys.stderr)
...
def deracer_handler (eh,mev):                               #line 67
    ...
    if  inst.state ==  "idle":                              #line 69
        if  "1" ==  mev.port:                               #line 70
            ...
            runtime_error ( str( "bad mev.port (case A) for deracer ") +  eh.name + " " + mev.port + " " + mev.datum.v )#line 77#line 78
        ...
        if  "1" ==  mev.port:                               #line 80
            ...
            runtime_error ( str( "bad mev.port (case B) for deracer ") +  eh.name + " " + mev.port + " " + mev.datum.v )#line 85#line 86
        ...
        if  "2" ==  mev.port:                               #line 88
            ...
            runtime_error ( str( "bad mev.port (case C) for deracer ") +  eh.name + " " + mev.port + " " + mev.datum.v )#line 93#line 94
    else:                                                   #line 95
...
def ensure_string_datum_handler (eh,mev):                   #line 115
    if  "string" ==  mev.datum.kind ():                     #line 116
        ...
        send_string ( eh, "✗", emev, mev)                   #line 120#line 121#line 122#line 123
...
def syncfilewrite_handler (eh,mev):                         #line 135
    ...
    if  "filename" ==  mev.port:                            #line 137
        ...
        if  f!= None:                                       #line 142
            ...
            send_string ( eh, "✗", str( "open error on file ") +  inst.filename , mev)#line 147#line 148#line 149#line 150#line 151
...
def maybe_stringconcat (eh,inst,mev):                       #line 179
    if  inst.buffer1!= None and  inst.buffer2!= None:       #line 180
        ...
        send_string ( eh, "", concatenated_string, mev)     #line 189
...
def string_constant_handler (eh,mev):                       #line 211
    s =  eh.instance_data                                   #line 212
    send_string ( eh, "", s, mev)                           #line 213#line 214#line 215
...
def fakepipename_handler (eh,mev):                          #line 223
    global rand                                             #line 224
    rand =  rand+ 1
    # not very random, but good enough _ ;rand' must be unique within a single run#line 225
    send_string ( eh, "", str( "/tmp/fakepipe") +  rand , mev)#line 226#line 227#line 228
                                                            #line 229
...
def switch1star_handler (eh,mev):                           #line 240
    inst =  eh.instance_data                                #line 241
    whichOutput =  inst.state                               #line 242
    if  "" ==  mev.port:                                    #line 243
        if  "1" ==  whichOutput:                            #line 244
            forward ( eh, "1", mev)                         #line 245
            inst.state =  "*"                               #line 246
        elif  "*" ==  whichOutput:                          #line 247
            forward ( eh, "*", mev)                         #line 248
        else:                                               #line 249
            send ( eh, "✗", "internal error bad state in switch1*", mev)#line 250#line 251
    elif  "reset" ==  mev.port:                             #line 252
        inst.state =  "1"                                   #line 253
    else:                                                   #line 254
        send ( eh, "✗", "internal error bad mevent for switch1*", mev)#line 255#line 256#line 257#line 258
...
def latch_handler (eh,mev):                                 #line 269
    inst =  eh.instance_data                                #line 270
    if  "" ==  mev.port:                                    #line 271
        inst.datum =  mev.datum                             #line 272
    elif  "release" ==  mev.port:                           #line 273
        d =  inst.datum                                     #line 274
        if  d ==  None:                                     #line 275
            send_string ( eh, "", "", mev)                  #line 276
            print ( " warning: *** latch sending empty string ***", file=sys.stderr)#line 277
        else:                                               #line 278
            send ( eh, "", d, mev)                          #line 279#line 280
        inst.datum =  None                                  #line 281
    else:                                                   #line 282
        send ( eh, "✗", "internal error bad mevent for latch", mev)#line 283#line 284#line 285#line 286
...
def shell_out_handler (eh,mev):                             #line 8
    cmd =  eh.instance_data                                 #line 9
    s =  mev.datum.v                                        #line 10
    ret =  None                                             #line 11
    rc =  None                                              #line 12
    stdout =  None                                          #line 13
    stderr =  None                                          #line 14
    ...
    try:
        ...
        stderr = str(e)
                                                            #line 15
    if  rc!= 0:                                             #line 16
        send_string ( eh, "✗", f'{stdout}{stderr}', mev)                 #line 17
    else:                                                   #line 18
        send_string ( eh, "", f'{stdout}{stderr}', mev)                  #line 19#line 20#line 21#line 22
...
def count_handler (eh,mev):                                 #line 4
    global count_counter, count_direction                   #line 5
    if  mev.port ==  "adv":                                 #line 6
        count_counter =  count_counter+ count_direction     #line 7
        send_int ( eh, "", count_counter, mev)              #line 8
    elif  mev.port ==  "rev":                               #line 9
...
def decode_handler (eh,mev):                                #line 5
    global decode_digits                                    #line 6
    s =  mev.datum.v                                        #line 7
    i = int ( s)                                            #line 8
    if  i >=  0 and  i <=  9:                               #line 9
        send_string ( eh, s, s, mev)                        #line 10#line 11
    send_bang ( eh, "done", mev)                            #line 12#line 13#line 14
...
class Delay_Info:
    def __init__ (self,):                                   #line 5
        ...
        self.saved_mevent =  None                          #line 7#line 8
                                                            #line 9
...
def delay_handler (eh,mev):                                 #line 22
    info =  eh.instance_data                                #line 23
    if first_time ( mev):                                   #line 24
        info.saved_mevent =  mev                           #line 25
        set_active ( eh)
    ...
    if  info.counter >=  DELAYDELAY:                        #line 31
        ...
        forward ( eh, "", info.saved_mevent)               #line 33
...
def monitor_handler (eh,mev):                               #line 10
    s =  mev.datum.v                                        #line 11
    i = int ( s)                                            #line 12
    while  i >  0:                                          #line 13
        s =  str( " ") +  s                                 #line 14

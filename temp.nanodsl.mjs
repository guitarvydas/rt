...
StatementBlock : function (line1,_11,line2,Statement,line3,_12,) {
enter_rule ("StatementBlock");
    set_return (`${line2.rwr ().join ('')}⤷${Statement.rwr ()}${line3.rwr ().join ('')}⤶\n`);
...
enter_rule ("Atom_listconst");
    set_return (`${_74.rwr ()}${line1.rwr ().join ('')}${PrimaryComma.rwr ().join ('')}${_75.rwr ()}${line2.rwr ()}`);

...
semantics {
  ...
  TopLevel =
   ...
   Defobj = kw<"defobj"> ident ObjFormals "{" InitStatement+ "}" line?
...
Defvar : function (_2,Lval,_3,Exp,) {
enter_rule ("Defvar");
    set_return (`${_2.rwr ()}${Lval.rwr ()}${_3.rwr ()}${Exp.rwr ()}`);
return exit_rule ("Defvar");
},
Defconst : function (_5,Lval,_6,Exp,) {
enter_rule ("Defconst");
    set_return (`${_5.rwr ()}${Lval.rwr ()}${_6.rwr ()}${Exp.rwr ()}`);
return exit_rule ("Defconst");
},
Defn : function (_8,ident,Formals,StatementBlock,) {
enter_rule ("Defn");
    set_return (`${_8.rwr ()}${ident.rwr ()}${Formals.rwr ()}${StatementBlock.rwr ()}`);
return exit_rule ("Defn");
},
Defobj : function (_10,ident,ObjFormals,_11,InitStatement,_12,) {
enter_rule ("Defobj");
    set_return (`${_10.rwr ()}${ident.rwr ()}${ObjFormals.rwr ()}${_11.rwr ()}${InitStatement.rwr ().join ('')}${_12.rwr ()}`);
return exit_rule ("Defobj");
},
Import : function (_14,ident,) {
enter_rule ("Import");
    set_return (`${_14.rwr ()}${ident.rwr ()}`);
return exit_rule ("Import");
},
StatementBlock : function (_15,Rec_Statement,_16,) {
enter_rule ("StatementBlock");
    set_return (`${_15.rwr ()}${Rec_Statement.rwr ()}${_16.rwr ()}`);
return exit_rule ("StatementBlock");
},
Rec_Statement_comment : function (comment,Rec_Statement,) {
enter_rule ("Rec_Statement_comment");
    set_return (`${comment.rwr ()}${Rec_Statement.rwr ().join ('')}`);
return exit_rule ("Rec_Statement_comment");
},
Rec_Statement_macro : function (Macro,) {
enter_rule ("Rec_Statement_macro");
    set_return (`${Macro.rwr ()}`);
return exit_rule ("Rec_Statement_macro");
},
Rec_Statement_deftemp : function (Deftemp,) {
enter_rule ("Rec_Statement_deftemp");
    set_return (`${Deftemp.rwr ()}`);
return exit_rule ("Rec_Statement_deftemp");
},
Rec_Statement_defsynonym : function (Defsynonym,) {
enter_rule ("Rec_Statement_defsynonym");
    set_return (`${Defsynonym.rwr ()}`);
return exit_rule ("Rec_Statement_defsynonym");
},
Rec_Statement_globals : function (_18,ident,CommaIdent,Rec_Statement,) {
...
Rec_Statement_call : function (Lval,Rec_Statement,) {
...
InitStatement : function (_40,ident,_41,Exp,comment,) {
enter_rule ("InitStatement");
    set_return (`${_40.rwr ()}${ident.rwr ()}${_41.rwr ()}${Exp.rwr ()}${comment.rwr ().join ('')}`);
...
Atom_listconst : function (_83,PrimaryComma,_84,) {
enter_rule ("Atom_listconst");
    set_return (`${_83.rwr ()}${PrimaryComma.rwr ().join ('')}${_84.rwr ()}`);
